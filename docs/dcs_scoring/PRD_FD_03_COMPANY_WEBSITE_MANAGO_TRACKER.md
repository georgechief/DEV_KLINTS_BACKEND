...
**Depends on:**  
- `Company.domain` populated (signup / Settings website — `company_domain`; see Engineering AUTH-01)  
...
| Doc | Relation |
|-----|----------|
| Engineering AUTH-01 | Collects / stores `Company.domain` (`company_domain`) |
| Engineering FE-03 | FD-03 `isOptional=true` — optional FAIL does not block dashboard |
