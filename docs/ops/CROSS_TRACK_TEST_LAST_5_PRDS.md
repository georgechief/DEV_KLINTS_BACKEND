...
**Audience:** Engineering · Engineering · Rohan (review)  
...
| Tester | Tests | Track |
|--------|-------|--------|
| **Engineering** | Engineering’s last 5 (§2) | Fix · writeback · evidence |
| **Engineering** | Engineering’s last 5 (§3) | Plan · PDF · AI · blueprint API |

---

## 2. Common test cases — Engineering track (Engineering executes)

PRDs: **FE-11B** · **WB-01C** · **WB-02** · **FE-12** · **WB-02B**  
Docs: `docs/engineering/PRD_*` (see `docs/engineering/README.md` #23–27).
...
**Engineering polish notes (while testing Engineering)**  
...
## 3. Common test cases — Engineering track (Engineering executes)

PRDs: **ORCH-01** · **RPT-01** · **RPT-01B** · **AI-01** · **WF-01**  
Docs: `docs/engineering/PRD_*` (see `docs/engineering/README.md` #6–10).
...
|-------|------------------------|
| **Engineering** | Engineering completes **TC-M3 + TC-M5** on prod without `/possible/` 500 **and** files §5 report |
| **Engineering** | Engineering completes **TC-S2 + TC-S5**; **TC-S6** listed under Gaps; §5 report filed |
...
Date:
Tester:
Track tested: Engineering | Engineering
Env: prod | staging
...
Engineering → Engineering TC-M1…M6
Engineering → Engineering TC-S1…S6
...
| Track | Index |
|-------|--------|
| Engineering | [docs/engineering/README.md](./engineering/README.md) |
| Engineering | [docs/engineering/README.md](./engineering/README.md) |
| WB-02B (P0 unblock) | [engineering/PRD_WB_02B_POSSIBLE_SHEET_RUNTIME_AND_DEMO.md](./engineering/PRD_WB_02B_POSSIBLE_SHEET_RUNTIME_AND_DEMO.md) |
