...
| Path | Role |
|------|------|
| `docs/sahil/PRD_CAP_01_CAPABILITY_MATRIX_RESOLVER.md` | This PRD |
...
| Repo | Paths (CAP-01) |
|------|----------------|
| **klints_backend** | `dataruns/capabilities/` · `dataruns/capabilities_urls.py` · `dataruns/use_cases/build_package.py` · `dataruns/writebacks/capabilities.py` (CAP-unify TODO) · `core/urls.py` · `dataruns/tests/test_capability_matrix_step*.py` · `scripts/verify_cap01_backend.py` · `scripts/gen_capability_matrix_seed.py` · `docs/sahil/CAP_01_WORKING_GAPS.md` · `docs/sahil/PRD_CAP_01_CAPABILITY_MATRIX_RESOLVER.md` · `docs/sahil/README.md` |
