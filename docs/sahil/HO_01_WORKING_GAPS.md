...
|------|-------------------|-----------------|
| **klints_backend** | BE Steps 1–6 (`feat(HO-01): staged handoff package APIs…`) | `docs/sahil/HO_01_WORKING_GAPS.md`, `docs/sahil/PRD_HO_01_HANDOFF_PACKAGE_BIND.md`, `scripts/verify_ho01_backend.py` |
