...
**BE files:** `docs/sahil/GAP_01_WORKING_GAPS.md` · `docs/sahil/PRD_GAP_01_M2_CODE_GAPS_WEEKS_5_9.md`
...
| **F0.8** | **W9-04** = markdown demo path + reset (`docs/sahil/`) — **not** an in-app tour. |
...
| Demo path doc | `docs/sahil/GAP_01F_DEMO_PATH.md` | **Done** (W9-04) | Operator walkthrough |
...
| Linked | `docs/sahil/README.md` build-order row |
...
- W9-04: `docs/sahil/GAP_01F_DEMO_PATH.md` — reset + connect→score→fix→studio→qa→handoff (not in-app tour)
