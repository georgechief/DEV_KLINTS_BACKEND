...
**Owner track:** Sahil (`docs/sahil/`) — **BE / deploy / ops** (no Klints product FE)  
...
Read:
- docs/sahil/PRD_M3_OBS_01_STAGING_GRAFANA_LOKI_ALLOY.md (this file)
...
**Phase 0 notes:** `docs/sahil/M3_OBS_01_PHASE_0.md` — URL locked `/grafana/`; deploy SSH via `main` workflow; mailer API confirmed for Phase 4 alerts. **Phase 0 complete** → Phase 1 compose.
...
**Phase 1 notes:** `docs/sahil/M3_OBS_01_PHASE_1.md`
...
**Phase 2 notes:** `docs/sahil/M3_OBS_01_PHASE_2.md` — in-repo filters ready; attach Explore screenshot when Grafana URL is live.
...
**Phase 3 notes:** `docs/sahil/M3_OBS_01_PHASE_3.md` — config ready; live login proof after PR merge / workflow deploy.
...
**Phase 4 notes:** `docs/sahil/M3_OBS_01_PHASE_4.md` — config ready; live mail proof after staging induce (Phase 6) or stop-and-flag.
...
| 5.3 | Runbook: `docs/sahil/M3_OBS_01_RUNBOOK.md` (login, Explore, alerts, redeploy) | [x] |
| 5.4 | Update `docs/sahil/README.md` build-order row | [x] |

**Exit:** Merge-ready; workflow is the test/deploy proof.  
**Phase 5 notes:** `docs/sahil/M3_OBS_01_PHASE_5.md` — config ready; live Actions green after merge (Phase 6).
...
**Phase 6 notes:** `docs/sahil/M3_OBS_01_PHASE_6.md` — induce marker `M3-OBS-01-INDUCE-WEB`; employer §11 paste block.
...
| **M3-SEC-01** | RBAC + tenant isolation evidence + security review packet — [PRD](./PRD_M3_SEC_01_RBAC_ISOLATION_SECURITY_PACKET.md) |
