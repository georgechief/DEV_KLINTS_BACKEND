...
**Owner track:** Sahil (`docs/sahil/`) — **BE + FE**  
...
Read:
- docs/sahil/PRD_QA_01_WORKFLOW_QA_GATE_ENGINE.md
- docs/sahil/PRD_WF_01_WORKFLOW_BLUEPRINT_STUDIO.md (§7.2 qa_requirements)
- docs/sahil/PRD_WF_02_FIX_FLOW_STAGES_AND_CHECK_ROUTING.md (§4 QA stage)
