...
**Owner track:** Sahil (`docs/sahil/`) — FE primary · BE only if journey cursor API needed  
...
Read:
- docs/sahil/PRD_WF_02_FIX_FLOW_STAGES_AND_CHECK_ROUTING.md
- docs/sahil/PRD_WF_01_WORKFLOW_BLUEPRINT_STUDIO.md (§3 gates, §5 CTAs, §7.5)
...
| `docs/sahil/PRD_WF_01_WORKFLOW_BLUEPRINT_STUDIO.md` | Studio, Fix vs Build CTAs, Flow D |
| `docs/sahil/PRD_UC_01_USE_CASE_LIBRARY_AND_PILOTS.md` | `ready` / `ready_provisional` / blocked |
| `docs/maheep/PRD_WB_02_*` / FE-08 | Fix writeback is **data** path — orthogonal to Studio eligibility |
