...
Read: docs/maheep/PRD_WB_01B_SANDBOX_PROOF_AND_LE04_FIX.md
...
5. Add docs/maheep/WRITEBACK_SURFACE_MATRIX.md (or §3 of this PRD kept current)
...
Ship this table in the PR (copy into `docs/maheep/WRITEBACK_SURFACE_MATRIX.md` **or** keep this section authoritative and link from README).
