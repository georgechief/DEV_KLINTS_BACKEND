...
**Owner track:** Maheep (`docs/maheep/`) — **BE + FE**  
**Surfaces:**  
...
Read:
- docs/maheep/PRD_WB_03_REAL_WRITEBACK_DB_GATE_AND_LOOM.md
...
PR [#46](https://github.com/Rohan070/klints_backend/pull/46) turned **`writeback_sandbox_enabled=True` for every company** (default + migration). That is unsafe and still framed as “sandbox.”
