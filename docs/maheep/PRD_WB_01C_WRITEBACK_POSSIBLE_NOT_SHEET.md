...
Read:
- docs/maheep/PRD_WB_01C_WRITEBACK_POSSIBLE_NOT_SHEET.md
- docs/maheep/PRD_WB_01B_SANDBOX_PROOF_AND_LE04_FIX.md (§3 matrix)
...
| `docs/maheep/WRITEBACK_POSSIBLE_NOT_SHEET.csv` | Human mirror / editorial copy (optional in prod) |
| `docs/maheep/WRITEBACK_POSSIBLE_NOT_SHEET.xlsx` | Optional Excel for humans (same columns) |
...
docs/maheep/writebacks_sandbox.postman_collection.json  # add /run/
