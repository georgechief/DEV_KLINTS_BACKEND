...
**Owner track:** Maheep (`docs/maheep/`) — **FE primary** (reuse existing assessment PDF BE; no new writeback APIs)  
...
Read:
- docs/maheep/PRD_FE_13_SHELL_HONESTY_AND_DEEP_LINKS.md
...
- docs/sahil/PRD_RPT_01_FULL_ASSESSMENT_REPORT_PDF.md (reuse only)
