...
**Owner track:** Maheep (`docs/maheep/`) — **BE + FE only if gaps found**; primarily **staging proof + Loom**  
...
Read:
- docs/maheep/PRD_WB_05_FIX_WRITEBACK_LOOM_STAGING_PROOF.md
- docs/maheep/PRD_WB_03_REAL_WRITEBACK_DB_GATE_AND_LOOM.md §8 (parent Loom script)
