...
Read:
- docs/maheep/PRD_POLISH_01_FIX_SHELL_AUDIT_IMMUTABLE.md
- docs/maheep/PRD_AUDIT_01_GOVERNANCE_ACTIVITY.md (§8 integrity)
- docs/maheep/PRD_AUDIT_02_AUDIT_NOTIFICATIONS.md (audit_read not in hash)
