...
**Owner track:** Maheep (`docs/maheep/`) — **BE primary · FE only if Entity column needs masked display**  
...
Read:
- docs/maheep/PRD_WB_07_ATOMIC_GATE_AND_RESPONSE_HYGIENE.md
- docs/maheep/PRD_WB_04_ONCE_PER_DCS_RUN_WRITEBACK_GATE.md
